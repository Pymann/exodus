/*
 * Exhaustive MISRA C++:2008 Violation Templates
 */

#include <iostream>
#include <cstdio>     // Rule 27-0-1: The stream I/O functions <cstdio> shall not be used
#include <cstring>
#include <cstdlib>
#include <cstdarg>    // Rule 8-4-1: features of <cstdarg> shall not be used
#include <setjmp.h>   // Rule 17-0-5: the standard header file <setjmp.h> shall not be used
#include <signal.h>   // Rule 18-7-1: the standard header file <signal.h> shall not be used
#include <time.h>     // Rule 18-0-4: the standard header file <time.h> shall not be used
...
// Rule 0-1-12: There shall be no unused variables in functions
void rule_0_1_12() {
    int never_used_local = 42; // Violation
}

// Rule 0-1-4: A project shall not contain non-volatile POD variables with only one use
void rule_0_1_4() {
...
// Rule 2-10-2: Identifiers declared in an inner scope shall not hide an identifier in an outer scope
int rule_2_10_2_var = 0;
void rule_2_10_2() {
    int rule_2_10_2_var = 1; // Violation
}

// Rule 2-10-3: A typedef name shall be a unique identifier
typedef int Rule_2_10_3_T;
typedef int Rule_2_10_3_T; // Violation

// Rule 2-10-4: A class, union or enum name shall be a unique identifier
...
// Rule 2-10-5: Identifier name of non-member object/function with static storage duration should not be reused
namespace rule_2_10_5_ns_a { static int reused_name = 0; }
namespace rule_2_10_5_ns_b { static int reused_name = 1; }

// Rule 2-10-6: Type and object/function identifiers should not be reused in the same scope
...
// Rule 3-1-3: When an array is declared, its size shall be explicitly specified
...
// Rule 3-3-2: Internal-linkage function re-declarations should include static in all declarations
namespace {
...
// Rule 2-13-2: Octal constants shall not be used
int rule_2_13_2 = 0123; // Violation

// Rule 2-13-3: A "U" suffix shall be applied to all octal or hexadecimal integer constants of unsigned type
unsigned int rule_2_13_3 = 0x123; // Violation (Missing U)
unsigned int rule_2_13_3_b = 0xFFFFFFFF; // Violation (Missing U)

// Rule 2-13-1: Only documented escape sequences shall be used
...
// Rule 5-2-4: C-style casts and functional notation casts shall not be used
void rule_5_2_4() {
    float f = 1.0f;
...
// Rule 5-2-5: A cast shall not remove any const or volatile qualification
void rule_5_2_5() {
    const int c = 5;
...
// Rule 5-3-1: Each operand of the ! operator, the logical && or || operators shall have type bool
void rule_5_3_1() {
    int x = 5;
    if (!x) {} // Violation
}
...
// Rule 5-8-1: The right hand operand of a shift operator shall lie between zero and one less than the width in bits of the left hand operand.
void rule_5_8_1() {
    unsigned int u = 1U;
...
// Rule 6-4-3: A switch statement shall be a well-formed switch statement (Needs default)
...
// Rule 6-6-1: Any label referenced by a goto statement shall be declared in the same block, or in a block enclosing the goto
void rule_6_6_1() {
...
// Rule 6-6-1: goto shall not jump into a block
...
// Rule 6-6-2: A goto statement shall jump to a label declared later in the same function
void rule_6_6_2() {
label:
    goto label; // Violation (backward jump)
}

// Rule 6-4-7: A switch-expression shall not have essentially Boolean type
void rule_6_4_7() {
    bool b = true;
    switch (b) { // Violation
        case 0: break;
...
// Rule 6-6-5: A function shall have a single point of exit at the end
int rule_6_6_5(bool cond) {
    if (cond) return 1; // Violation
    return 0;
}

// Rule 6-4-1: if ... else if chains shall terminate with else
...
// Rule 8-4-2: Function declarations shall use the same parameter names and qualifiers
int rule_8_4_2(int lhs);
int rule_8_4_2(int rhs) { return rhs; } // Violation (parameter name mismatch)

// Rule 8-4-3: All exit paths from non-void function shall return a value
...
// Rule 8-5-1: Variables shall not be used before they have been set
int rule_8_5_1() {
    int x;
    return x; // Violation
}
...
// Rule 0-1-10: Every defined function should be called at least once
static int rule_0_1_10_unused_internal() {
    return 7;
}

// Rule 0-1-8: A void function should have external side effects
static void rule_0_1_8_no_side_effect() {
    int local_value = 0;
    (void)local_value;
}

// Rule 0-1-6: Undefined behavior (division by zero)
int rule_0_1_6_div_zero() {
    return 1 / 0; // Violation
}

// Rule 0-1-7: Value under different evaluation orders
...
// Rule 0-3-2: Error information should not be discarded
void rule_0_3_2_ignore_error_info() {
    fopen("missing.txt", "r"); // Violation
}

// Rule 5-3-4: sizeof operand should have no side effects
void rule_5_3_4() {
    int i = 0;
    (void)sizeof(i++); // Violation
}

// Rule 5-18-1: The comma operator should not be used
int rule_5_18_1() {
    int a = 0;
...
// Rule 5-0-15: Pointer arithmetic should not be used
void rule_5_0_15() {
    int arr[4] = {0, 1, 2, 3};
    int* p = arr;
    p = p + 1; // Violation
...
// Rule 7-5-4: Functions shall not call themselves directly
...
// Rule 8-5-2: Braces shall match aggregate structure
struct Rule_8_5_2_S {
    int a[2];
};
...
// Policy fixture: uses the preprocessor beyond file inclusion and include guards.
#define MACRO_VAL 5 // Violation
#undef MACRO_VAL    // Violation
# // Rule 16-0-8: # token shall be followed by a preprocessing token (Violation)
...
// Rule 27-0-1: The stream I/O functions <cstdio> shall not be used
void rule_27_0_1() {
    printf("Hello\n"); // Violation
}

void rule_18_0_2_3_4() {
    (void)atoi("123"); // Rule 18-0-2
    time(nullptr);     // Rule 18-0-4
    exit(1);           // Rule 18-0-3
}
