...
int rule_1_2_statement_expr(void) {
...
int __reserved_rule_21_2 = 0; // Violation
...
enum rule_8_12_e { E1 = 0, E2, E3 = 0, E4 }; // Violation (E2=1, E4=1 both implicit)
...
void rule_9_5_local(void) {
    int local_arr[] = { [1] = 10 }; // Violation
    (void)local_arr[1];
}
